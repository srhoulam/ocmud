...
const surfaces = [
    "patch of dirt", "chalkboard", "wall",
    "notebook", "clay tablet"
];

function generateLocationName(cultureIndex, adjectiveIndex, nounIndex) {
    return [
